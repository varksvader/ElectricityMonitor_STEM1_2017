...
const float AC_WALL_VOLTAGE     = 120;
const float AC_ADAPTER_VOLTAGE  = 12;
const float AC_VOLTAGE_DIV_VOUT = 12;
const float CT_BURDEN_RESISTOR  = 33;
const float CT_TURNS            = 3000.0;
...
void displayPower() {
  ...
  Serial.print("va ");
  //Serial.print(powerFactor * 100, 0);
  //Serial.print("% ");
  //Serial.setCursor(0,1);
  Serial.print(voltageRMS, 0);
  Serial.print("v ");
  Serial.print(currentRMS, 1);
  Serial.println("a ");
